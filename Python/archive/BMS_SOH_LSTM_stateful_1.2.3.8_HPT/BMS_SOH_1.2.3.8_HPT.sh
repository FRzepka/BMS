...
#SBATCH --mem=200G                     # 30GiB resident memory pro Node
...
python /home/users/f/flo01010010/HPC_projects/Scripts/BMS/Python/BMS_SOH_LSTM_stateful_1.2.3.8_HPT/BMS_SOH_LSTM_stateful_1.2.3.8_HPT.py