...
class WindowedDataset(Dataset):
    def __init__(self, df, seq_len=5000):
...
def build_model(input_size=2, hidden_size=64, num_layers=1, dropout=0.2, mlp_hidden=32):
...
def train_online(epochs=20, lr=1e-3, seq_len=5000, batch_size=128):
