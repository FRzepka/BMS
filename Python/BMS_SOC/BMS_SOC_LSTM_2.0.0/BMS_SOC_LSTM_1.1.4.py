...
# Custom Loss: DirectionLoss
class DirectionLoss(nn.Module):
    """
    Kombiniert MSE-Loss mit Strafterm dafür, wenn
    - Current > 0 und y_pred < letzter SOC
    - Current < 0 und y_pred > letzter SOC
    """
...
# Replace criterion definition:
# criterion = nn.MSELoss()
criterion = DirectionLoss(alpha=0.1)  # new loss function
...
for epoch in range(1, epochs+1):
    ...
    for i, (x_batch, y_batch) in enumerate(train_loader):
        ...
        loss = criterion(y_pred, y_batch, x_batch) / accumulation_steps    # updated loss call
    ...
    with torch.no_grad():
        for x_val, y_val in val_loader:
            ...
            v_loss = criterion(y_pred_val, y_val, x_val)    # updated loss call
